...
txn_header_bytes = TransactionHeader(
	...
	#inputs and outputs is address generated by specific rules
	#Example: hashlib.sha512('intkey'.encode('utf-8')).hexdigest()[0:6] + hashlib.sha512('foo'.encode('utf-8')).hexdigest()[-64:]
	#'1cf1266e282c41be5e4254d8820772c5518a2c5a8c0c7f7eda19594a7eb539453e1ed7'
	#>>> hashlib.sha512('intkey'.encode('utf-8')).hexdigest()[0:6] + hashlib.sha512('Hello World!'.encode('utf-8')).hexdigest()[-64:]
	#'1cf1263371015ead891cc3cf1c9d34b49264b510751b1ff9e537937bc46b5d6ff4ecc8'
	inputs=['1cf1263371015ead891cc3cf1c9d34b49264b510751b1ff9e537937bc46b5d6ff4ecc8'],
	outputs=['1cf1263371015ead891cc3cf1c9d34b49264b510751b1ff9e537937bc46b5d6ff4ecc8'],
